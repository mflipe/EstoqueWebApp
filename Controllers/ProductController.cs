...
public class ProductController : Controller
{
    ...
    public async Task<IActionResult> Index()
    {
        return _context.ProductViewModel != null ?
                    ...
                    Problem("Entity set 'ApplicationDbContext.ProductModel'  is null.");
    }
    ...
    public async Task<IActionResult> Create([Bind("Id,Name,Description,Quantity,Price")] ProductModel productViewModel)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Quantity,Price")] ProductModel productViewModel)
    {
